...
#define TS_DGL_LOCK_START			TIMESTAMP_CUR(175)
#define TS_DGL_LOCK_SUSPEND			TIMESTAMP_CUR(176)
#define TS_DGL_LOCK_RESUME			TIMESTAMP_CUR(177)
#define TS_DGL_LOCK_END				TIMESTAMP_CUR(178)
#define TS_DGL_UNLOCK_START			TIMESTAMP_CUR(185)
#define TS_DGL_UNLOCK_END			TIMESTAMP_CUR(186)
#endif
...
#define TS_UPDATE_GPU_EST_START		TIMESTAMP_CUR(210)
#define TS_UPDATE_GPU_EST_END		TIMESTAMP_CUR(211)
